...
type
  ...
  private
    ...
    /// <remarks>
    /// Este m�todo realiza v�rias opera��es de inicializa��o,
    /// incluindo a cria��o de registros de gerente, loja e suporte.
    /// </remarks>
    /// <remarks>
    /// Quando ainda n�o existe pessoa, n�o � poss�vel gerar um log.
    /// Logs aqui s�o necess�rios pois ser�o usados para notificar os PDVs
    ...
    ///
    /// Depois que o registro da pessoa do gerente j� existe,
    /// pode-se criar a loja e as demais tabelas.
    /// Mesmo o gerente agora ser� regravado usando stored procedures
    /// e todos ter�o os seus logs registrados.
    ///
    /// a� que entra a <c>GravarIniciais_CrieGerenteFinal</c>
    /// </remarks>
    /// <exception cref="EAbort">Lan�a uma exce��o se estiver em um terminal.</exception>
  ...
  protected
    ...
    /// se o banco de dados existia, se n�o existia e foi copiado, ou se n�o
    /// existia.
    /// dbeExistia - O banco de dados j� existia.
    ...
    /// conecta a ele.
    /// </summary>
    /// <returns>A vers�o do banco de dados.</returns>
    /// <remarks>
    /// verifica se o banco de dados existe e, se n�o existir, cria.
    /// Em seguida, conecta ao banco de dados e prepara as opera��es principais.
    /// Se a tabela de hist�rico de atualiza��es n�o existir, retorna -1.
    /// Caso contr�rio, retorna a �ltima vers�o registrada nesta tabela
    /// </remarks>
    /// <exception cref="Exception">Lan�a uma exce��o se houver erro ao criar ou conectar ao banco de dados.</exception>
