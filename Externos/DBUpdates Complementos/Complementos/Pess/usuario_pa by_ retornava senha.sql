...
BEGIN
  ...
  PROCEDURE TRAZER_OPCOES_PERFIL_FUNCIONARIO
  (
    LOJA_ID ID_SHORT_DOM NOT NULL,
...
EXECUTE PROCEDURE USUARIO_PA.TRAZER_OPCOES_PERFIL_FUNCIONARIO(1,3);
SELECT * FROM USUARIO_PODE_OPCAO_SIS;
...
*/
  ...
  BEGIN
    ...
    EXECUTE PROCEDURE TRAZER_OPCOES_PERFIL_FUNCIONARIO (LOJA_ID, PESSOA_ID);
  END
  ...
  BEGIN
    DELETE FROM USUARIO_TEM_PERFIL_DE_USO WHERE LOJA_ID = :LOJA_ID AND TERMINAL_ID = 0 AND PESSOA_ID = :PESSOA_ID;
    --DELETE FROM USUARIO_TEM_PERFIL_DE_USO WHERE LOJA_ID = :LOJA_ID AND TERMINAL_ID = 0 AND PESSOA_ID = :PESSOA_ID;
  ...
  END
  /*
EXECUTE PROCEDURE USUARIO_PA.TEM_PERFIS_GARANTIR(1, 3, '1;2');

SELECT * FROM USUARIO_TEM_PERFIL_DE_USO;

SELECT * FROM PERFIL_DE_USO_PODE_OPCAO_SIS;

SELECT * FROM USUARIO_PODE_OPCAO_SIS WHERE PESSOA_ID=3;
SHOW PACKAGE USUARIO_PA;  
  */
END^
SET TERM ;^
