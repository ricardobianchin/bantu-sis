...
SHOW PROCEDURE CAIXA_SESSAO_MANUT_PA.CAIXA_SESSAO_OPERACAO_INSERIR_DO;
...
SELECT *
FROM CAIXA_SESSAO_MANUT_PA.OPER_ORDEM_PROXIMO_GET
(1, 1, 12, NULL);
...
BEGIN
  ...
  BEGIN
    ...
    :LOG_DESCR_RET = :LOG_DESCR_RET || ' / OPER_ORDEM_RET='||CAST(:OPER_ORDEM_RET AS VARCHAR(400));
    ...
    :OPER_TIPO_ORDEM)
    INTO :OPER_TIPO_ORDEM_RET;
    :LOG_DESCR_RET = :LOG_DESCR_RET || ' / OPER_TIPO_ORDEM_RET='||CAST(:OPER_TIPO_ORDEM_RET AS VARCHAR(400));
    ...
    :LOG_DESCR_RET = :LOG_DESCR_RET || ' / OPER_LOG_ID_RET='||CAST(:OPER_LOG_ID_RET AS VARCHAR(400));
  ...
  BEGIN
    ...
    :LOG_DESCR = 'SESS_ID_RET='||CAST(:SESS_ID_RET AS VARCHAR(400));    
    
    SELECT OPER_ORDEM_RET, OPER_LOG_ID_RET, OPER_TIPO_ORDEM_RET, LOG_DESCR_RET
    ...
    INTO :OPER_ORDEM_RET, :OPER_LOG_ID_RET, :OPER_TIPO_ORDEM_RET, :LOG_DESCR;
