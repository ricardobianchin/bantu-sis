...
BEGIN
  ...
  AS    
    DECLARE SESS_ID_RET ID_DOM;
    DECLARE OPER_ORDEM_RET SMALLINT;
    DECLARE OPER_LOG_ID_RET BIGINT;
    DECLARE OPER_TIPO_ORDEM_RET SMALLINT;
    DECLARE LOG_DTH TIMESTAMP;
  ...
  BEGIN
    ...
    :LINHA_TEXTO = CAST(:SESS_ID_RET AS VARCHAR(60));
    SUSPEND;

    :LINHA_TEXTO = CAST(:OPER_ORDEM_RET AS VARCHAR(60));
    SUSPEND;
    
    :LINHA_TEXTO = CAST(:OPER_LOG_ID_RET AS VARCHAR(60));
    SUSPEND;
    
    :LINHA_TEXTO = CAST(:OPER_TIPO_ORDEM_RET AS VARCHAR(60));
    SUSPEND;
    
    :LINHA_TEXTO = CAST(:LOG_DTH AS VARCHAR(60));
    SUSPEND;  
