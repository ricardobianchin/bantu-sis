...
BEGIN
  ...
  (
    ...
    , CUSTO_UNIT CUSTO_DOM NOT NULL
    , CUSTO DINH_DOM NOT NULL
    
    , PRECO_UNIT_ORIGINAL DINH_DOM NOT NULL
    , PRECO_UNIT_PROMO DINH_DOM NOT NULL
    , PRECO_UNIT DINH_DOM NOT NULL
    , PRECO_BRUTO DINH_DOM NOT NULL
    
    , DESCONTO DINH_DOM NOT NULL
    , PRECO DINH_DOM NOT NULL
...
BEGIN
  ...
  AS
    DECLARE PRECO DINH_DOM;
    DECLARE DESCONTO DINH_DOM;
  ...
  AS
    ...
    DECLARE ALTERADO_EM_RET TIMESTAMP;
  BEGIN
    SELECT 
      FIRST(1)
      EM.LOJA_ID
    ...
    BEGIN
      ALTERADO_EM_RET = CURRENT_TIMESTAMP;
      ...
      BEGIN
        UPDATE EST_MOV 
        SET ALTERADO_EM = :ALTERADO_EM_RET
        WHERE 
          LOJA_ID = :LOJA_ID
          AND TERMINAL_ID = :TERMINAL_ID
          AND EST_MOV_ID = :EST_MOV_ID;
