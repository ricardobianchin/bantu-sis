...
BEGIN
  ...
  BEGIN
    ...
    SELECT EST_MOV_ID_RET, EST_MOV_ITEM_ORDEM_RET
    ...
    (
      ...
      , NULL -- EST_MOV_DTH_DOC
      , :EST_MOV_ITEM_ORDEM
      , :PROD_ID
      , :QTD
    )
    INTO :EST_MOV_ID_RET, :EST_MOV_ITEM_ORDEM_RET;
    :LOG_STR_RET = :LOG_STR_RET ||';EST_MOV_ID_RET='||:EST_MOV_ID_RET;
    :LOG_STR_RET = :LOG_STR_RET ||';EST_MOV_ITEM_ORDEM_RET='||:EST_MOV_ITEM_ORDEM_RET;
  ...
  BEGIN
    ...
    BEGIN
      ...
      :LOG_STR_RET = :LOG_STR_RET || ';VAI VENDA_ITEM_INS';
      
      SELECT EST_MOV_ID_RET, EST_MOV_ITEM_ORDEM_RET, VENDA_ID_RET, LOG_STR_RET
      FROM VENDA_ITEM_INS
      (
        :LOJA_ID
        , :TERMINAL_ID
        , :EST_MOV_ID
        , NULL -- :EST_MOV_ITEM_ORDEM
        , :VENDA_ID
      ...
      INTO :EST_MOV_ID_RET, :EST_MOV_ITEM_ORDEM_RET, :VENDA_ID_RET, :LOG_STR_RET;
