...
BEGIN
  ...
  (
    ...
    , TIPO_ID SMALLINT  --  5
    , TIPO_DESCR NOME_INTERM_DOM  --  6
    , UNID_ID SMALLINT  --  7
    , UNID_SIGLA CHAR(6)  --  8
    , ICMS_ID SMALLINT  --  9
    , ICMS_DESCR_PERC NOME_INTERM_DOM  --  10

    , PROD_NATU_ID ID_CHAR_DOM NOT NULL  --  11
    , PROD_NATU_NOME NOME_REDU_DOM NOT NULL  --  12
...
BEGIN
  ...
  (
    ...
    , COD_BARRAS VARCHAR(233)  --  13

    , CUSTO CUSTO_DOM  --  14
    , PRECO PRECO_DOM  --  15

    , ATIVO BOOLEAN  --  16
    , LOCALIZ NOME_CURTO_DOM  --  17
    , CAPAC_EMB NUMERIC(8, 3)  --  18
    , NCM CHAR(8)  --  19
    , MARGEM MARGEM_DOM  --  20

    , BALANCA_EXIGE BOOLEAN  --  21
    , BAL_DPTO CHAR(3)  --  22
    , BAL_VALIDADE_DIAS SMALLINT  --  23
    , BAL_TEXTO_ETIQ VARCHAR(400)  --  24
  )
  AS 
  BEGIN 
    -- PROD_PA.LISTA_GET COD
    FOR
      WITH
      B AS ( -- BARRAS
      ...
      NA AS ( -- PROD_NATU
        SELECT PROD_NATU_ID, NOME AS PROD_NATU_NOME
        FROM PROD_NATU
      ),
      CO AS ( -- PROD_COMPL
      ...
      , P.PROD_NATU_ID, NA.PROD_NATU_NOME
      ...
      JOIN NA ON P.PROD_NATU_ID = NA.PROD_NATU_ID -- NA=PROD_NATU
...
{FIMSE}*/
  ...
  BEGIN
    ...
    EXECUTE PROCEDURE PROD_CUSTO_PA.PROD_CUSTO_HIST_INS(
      :PROD_ID, :LOJA_ID, :PESSOA_ID, :MACHINE_ID, :CUSTO, 0, 0
...
{FIMSE}*/
  ...
  BEGIN
    ...
    EXECUTE PROCEDURE PROD_CUSTO_PA.PROD_CUSTO_HIST_INS(
      :PROD_ID, :LOJA_ID, :PESSOA_ID, :MACHINE_ID, :CUSTO, NULL, NULL
      ) RETURNING_VALUES :LOG_ID_RET;
