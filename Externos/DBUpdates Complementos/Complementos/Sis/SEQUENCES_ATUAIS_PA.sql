...
BEGIN
  ...
  -- SEQUENCES_ATUAIS.VALUES_SET DEF
...
BEGIN
  ...
  -- SEQUENCES_ATUAIS.VALUES_SET IMP
  PROCEDURE VALUES_SET
  (
    TERMINAL_ID ID_SHORT_DOM NOT NULL,
    CAIXA_SESSAO_SEQ BIGINT,
  ...
  AS
  BEGIN
    -- SEQUENCES_ATUAIS.VALUES_SET COD
    /* Atualiza ou insere os valores das sequências atuais para o TERMINAL_ID */
...
/*
SELECT CAIXA_SESSAO_SEQ, EST_MOV_SEQ, LOG_SEQ, PESSOA_SEQ, VENDA_SEQ FROM SEQUENCES_ATUAIS_PA.VALUES_GET(1);
*/