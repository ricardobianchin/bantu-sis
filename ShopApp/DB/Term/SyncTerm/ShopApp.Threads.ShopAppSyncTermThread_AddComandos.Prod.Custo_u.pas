unit ShopApp.Threads.ShopAppSyncTermThread_AddComandos.Prod.Custo_u;
...
type
  TSyncTermAddComandosProdCustoShop = class(TSyncTermAddComandos)
  private
...
{ TSyncTermAddComandosProdCustoShop }

procedure TSyncTermAddComandosProdCustoShop.Execute(pLogIdIni,
  pLogIdFin: Int64);
var
  sSql: string;
  q: TDataSet;
...
function TSyncTermAddComandosProdCustoShop.GetSqlServLogs(pLogIdIni,
