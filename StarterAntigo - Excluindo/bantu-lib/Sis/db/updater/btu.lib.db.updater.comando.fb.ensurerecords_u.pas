...
uses btu.lib.db.updater.comando, System.Classes,
  ...
  sis.ui.io.ProcessLog, sis.ui.io.output;
...
begin
  ...
  ProcessLog.Exibir(AsText + ' Inicio');
  ProcessLog.Exibir('StartTransaction');
...
begin
  ...
  FTemDBQuery := DBQueryCreate(DBConnection, sSqlTem, ProcessLog, output);
  try
    FTemDBQuery.Prepare;
  except
    on E: Exception do
  ...
  FInsDBExec := DBExecCreate(DBConnection, sSqlIns, ProcessLog, output);
  try
    FInsDBExec.Prepare;
  except
    on E: Exception do
  ...
  FUpdDBExec := DBExecCreate(DBConnection, sSqlUpd, ProcessLog, output);
  try
    FUpdDBExec.Prepare;
  except
    on E: Exception do
