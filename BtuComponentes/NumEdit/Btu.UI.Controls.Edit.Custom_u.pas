unit Btu.UI.Controls.Edit.Custom_u;
...
type
  TCustomBtuEdit = class(TCustomLabeledEdit)
  private
...
procedure Register;
begin
//  RegisterComponents('Edits', [TCustomBtuEdit]);
end;

{ TCustomBtuEdit }

{function TCustomBtuEdit.AceitaKey(pKey: integer): boolean;
begin
  result:=true;
end;}

function TCustomBtuEdit.GetAsCurrency: currency;
var
  s:string;
begin
  try
...
function TCustomBtuEdit.AsFloat: double;
var
  s:string;
begin
  try
...
function TCustomBtuEdit.AsInteger: integer;
var
  s:string;
begin
  try
...
procedure TCustomBtuEdit.AtualizarDigitado;
begin

end;

function TCustomBtuEdit.CanExit: boolean;
begin
  result:=ValorAceitavel;
end;

constructor TCustomBtuEdit.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TCustomBtuEdit.CreateParams(var Params: TCreateParams);
const
...
procedure TCustomBtuEdit.DoEnter;
begin
  inherited;

end;

procedure TCustomBtuEdit.DoExit;
begin
  inherited;
//  if not CanExit then
//    SetFocus;
...
function TCustomBtuEdit.EhDig(C: Char): boolean;
begin
  result:=pos(C,'0123456789')>0;
end;

function TCustomBtuEdit.GetCaption: string;
begin
  result:=EditLabel.Caption;
end;

function TCustomBtuEdit.GetReadOnly: Boolean;
begin
  Result := inherited ReadOnly;
end;

function TCustomBtuEdit.GetValor: variant;
begin
  if FDigitado='' then
    result:=0
  else
...
procedure TCustomBtuEdit.IndicarPosCursor;
begin
...
function TCustomBtuEdit.IntToStrZero(pI: int64; pNCasas: integer): string;
var
...
procedure TCustomBtuEdit.KeyDown(var Key: Word; Shift: TShiftState);
begin
  inherited;
  case key of
    13:
...
procedure TCustomBtuEdit.KeyUp(var Key: Word; Shift: TShiftState);
begin
  inherited;
  IndicarPosCursor;
end;

procedure TCustomBtuEdit.PreencherText;
begin
  //deverá preencher text a partir de digitado
end;

function TCustomBtuEdit.SemZeroAEsquerda(S: string): string;
begin
  s:=trim(s);
  while Length(s)>0 do
  begin
...
procedure TCustomBtuEdit.SetAlignment(const Value: TAlignment);
begin
  FAlignment := Value;
  RecreateWnd;
end;

procedure TCustomBtuEdit.SetCaption(const Value: string);
begin
  EditLabel.Caption:=Value;
end;

procedure TCustomBtuEdit.SetDigitado(const Value: string);
begin
  FDigitado := Value;
  PreencherText;
end;

procedure TCustomBtuEdit.SetParent(AParent: TWinControl);
begin
  inherited;
...
procedure TCustomBtuEdit.SetPosCursor(const Value: integer);
begin
  FPosCursor:=value;
  if FOverwrite then
  begin
...
procedure TCustomBtuEdit.SetReadOnly(Value: Boolean);
begin
...
procedure TCustomBtuEdit.SetValor(const Value: variant);
begin
...
function TCustomBtuEdit.SoDig(s: string): string;
var
  t:integer;
begin
  result:='';
...
function TCustomBtuEdit.SQLString: string;
begin
  result:=QuotedStr(Text);
end;

function TCustomBtuEdit.StrAEsqDoCaracter(pCaracter, pStr: string): string;
var
  t:integer;
begin
...
function TCustomBtuEdit.StrDireita(S: string; NCharsDir: integer): string;
var
  Posicao:integer;
begin
  result:='';
...
function TCustomBtuEdit.StrToNum(S: string): double;
begin
  if Trim(s)='' then
    s:='0';
...
function TCustomBtuEdit.StrToNumStr(S: string): string;
var
  npontos,t:integer;
  c:string;
...
function TCustomBtuEdit.StrToNumStrPonto(S: string): string;
var
  npontos,t:integer;
  c:string;
begin
...
function TCustomBtuEdit.ValorAceitavel: boolean;
begin
  result:=true;
end;
