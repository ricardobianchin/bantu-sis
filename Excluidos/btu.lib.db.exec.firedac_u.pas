...
begin
  ProcessLog.Exibir('TDBExecFireDac.Destroy');
...
begin
  inherited;
  ProcessLog.Exibir('Executará'#13#10+SQL+#13#10+GetParamsAsStr);
  FDCommand.Execute;
end;
...
begin
  ...
  begin
    ProcessLog.Exibir('TDBExecFireDac.Prepare,FDCommand.Prepare');
    FDCommand.Prepare;
  end;
end;
...
begin
  ...
  begin
    ProcessLog.Exibir('TDBExecFireDac.Unprepare,FDCommand.Unprepare');
    FDCommand.Unprepare;
  end;
end;
