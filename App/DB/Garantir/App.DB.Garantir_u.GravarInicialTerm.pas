...
var
  sSql: string;
begin
  sSql := 'DELETE FROM TERMINAL;'#13#10;
...
//sSql := 'UPDATE TERMINAL SET'#13#10 //
//    + '  TERMINAL_ID = ' + T.TerminalId.ToString + ';'//
//    + ', APELIDO = ' + T.Apelido.QuotedString + ' -- APELIDO'#13#10 //
//    + ', NOME_NA_REDE = ' + T.NomeNaRede.QuotedString + ' -- NOME_NA_REDE'#13#10 //
//    + ', IP = ' + T.IP.QuotedString + ' -- IP'#13#10 //
//    + ', LETRA_DO_DRIVE = ' + T.LetraDoDrive.QuotedString + ' -- LETRA_DO_DRIVE'#13#10 //
//    + ', NF_SERIE = ' + T.NFSerie.ToString + ' -- NF_SERIE'#13#10 //
//    + ', GAVETA_TEM = ' + BooleanToStrSQL(T.GavetaTem) + ' -- GAVETA_TEM'#13#10 //
//    + ', GAVETA_COMANDO = ' + T.GavetaComando.QuotedString + ' -- GAVETA_COMANDO'#13#10 //
//    + ', GAVETA_IMPR_NOME = ' + T.GavetaImprNome.QuotedString + ' -- GAVETA_IMPR_NOME'#13#10 //
//    + ', BALANCA_MODO_USO_ID = ' + T.BalancaModoUsoId.ToString + ' -- BALANCA_MODO_USO_ID'#13#10 //
//    + ', BALANCA_ID = ' + T.BalancaId.ToString + ' -- BALANCA_ID'#13#10 //
//    + ', BARRAS_COD_INI = ' + T.BarCodigoIni.ToString + ' -- BARRAS_COD_INI'#13#10 //
//    + ', BARRAS_COD_TAM = ' + T.BarCodigoTam.ToString + ' -- BARRAS_COD_TAM'#13#10 //
//    + ', IMPRESSORA_MODO_ENVIO_ID = ' + T.ImpressoraModoEnvioId.ToString + ' -- IMPRESSORA_MODO_ENVIO_ID'#13#10 //
//    + ', IMPRESSORA_MODELO_ID = ' + T.ImpressoraModeloId.ToString + ' -- IMPRESSORA_MODELO_ID'#13#10 //
//    + ', IMPRESSORA_NOME = ' + T.ImpressoraNome.QuotedString + ' -- IMPRESSORA_NOME'#13#10 //
//    + ', IMPRESSORA_COLS_QTD = ' + T.ImpressoraColsQtd.ToString + ' -- IMPRESSORA_COLS_QTD'#13#10 //
//    + ', CUPOM_QTD_LINS_FINAL = ' + T.CupomQtdLinsFinal.ToString + ' -- CUPOM_QTD_LINS_FINAL'#13#10 //
//    + ', SEMPRE_OFFLINE = ' + BooleanToStrSQL(T.SempreOffLine) + ' -- SEMPRE_OFFLINE'#13#10 //
//    + ', ATIVO = ' + BooleanToStrSQL(T.Ativo) + ' -- ATIVO'#13#10 //
//    + ', BALANCA_PORTA = ' + T.Balanca_Porta.ToString + ' -- BALANCA_PORTA'#13#10 //
//    + ', BALANCA_BAUDRATE = ' + T.Balanca_Baudrate.ToString + ' -- BALANCA_BAUDRATE'#13#10 //
//    + ', BALANCA_DATABITS = ' + T.Balanca_Databits.ToString + ' -- BALANCA_DATABITS'#13#10 //
//    + ', BALANCA_PARIDADE = ' + T.Balanca_Paridade.ToString + ' -- BALANCA_PARIDADE'#13#10 //
//    + ', BALANCA_STOPBITS = ' + T.Balanca_Stopbits.ToString + ' -- BALANCA_STOPBITS'#13#10 //
//    + ', BALANCA_HANDSHAKING = ' + T.Balanca_Handshaking.ToString + ' -- BALANCA_HANDSHAKING'#13#10 //
//    + ';';

sSql := 'INSERT INTO TERMINAL'#13#10 //
    + '('#13#10 //
    + '  TERMINAL_ID'#13#10 //
    + ', APELIDO'#13#10 //
    + ', NOME_NA_REDE'#13#10 //
    ...
    + ', ' + T.BarCodigoIni.ToString + ' -- BARRAS_COD_INI'#13#10 //
    + ', ' + T.BarCodigoTam.ToString + ' -- BARRAS_COD_TAM'#13#10 //
    + ', ' + T.ImpressoraModoEnvioId.ToString + ' -- IMPRESSORA_MODO_ENVIO_ID'#13#10 //
    + ', ' + T.ImpressoraModeloId.ToString + ' -- IMPRESSORA_MODELO_ID'#13#10 //
    + ', ' + T.ImpressoraNome.QuotedString + ' -- IMPRESSORA_NOME'#13#10 //
    + ', ' + T.ImpressoraColsQtd.ToString + ' -- IMPRESSORA_COLS_QTD'#13#10 //
    + ', ' + T.CupomQtdLinsFinal.ToString + ' -- CUPOM_QTD_LINS_FINAL'#13#10 //
    + ', ' + BooleanToStrSQL(T.SempreOffLine) + ' -- SEMPRE_OFFLINE'#13#10 //
    + ', ' + BooleanToStrSQL(T.Ativo) + ' -- ATIVO'#13#10 //
...
begin
  ...
  try
    ...
    DBExecScript.Sql.SaveToFile('C:\DarosPDV\Garantir term.sql');
    DBExecScript.Execute;
//    showmessage('C:\DarosPDV\Garantir term.sql');
  finally
