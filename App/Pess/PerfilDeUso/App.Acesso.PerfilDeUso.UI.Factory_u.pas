...
function PerfilDeUsoEdFormCreate(AOwner: TComponent; pAppObj: IAppObj;
  pPerfilDeUso: IEntEd; pPerfilDeUsoDBI: IEntDBI): TEdBasForm;

function PerfilDeUsoPerg(AOwner: TComponent; pAppObj: IAppObj;
...
function PerfilDeUsoEdFormCreate(AOwner: TComponent; pAppObj: IAppObj;
  pPerfilDeUso: IEntEd; pPerfilDeUsoDBI: IEntDBI): TEdBasForm;
begin
  Result := TPerfilDeUsoEdForm.Create(AOwner, pAppObj, pPerfilDeUso,
    pPerfilDeUsoDBI);
end;
...
var
  F: TEdBasForm;
begin
  F := PerfilDeUsoEdFormCreate(AOwner, pAppObj, pPerfilDeUsoEnt,
    pPerfilDeUsoDBI);
  try
    Result := F.Perg;
  finally
