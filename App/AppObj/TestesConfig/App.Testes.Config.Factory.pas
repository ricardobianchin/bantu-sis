...
function ModuRetagAcessoPerfilDeUsoCreate
  : ITesteConfigModuRetagAcessoPerfilDeUso;
function ModuRetagAcessoFuncionarioCreate
  : ITesteConfigModuRetagAcessoFuncionario;
...
function ModuRetagFinPagamentoFormaCreate
  : ITesteConfigModuRetagFinPagamentoForma;
...
function ModuRetagAjudaBemVindoTerminaisCreate
  : ITesteConfigModuRetagAjudaBemVindoTerminais;
...
function ModuRetagFinCreate: ITesteConfigModuRetagFin;
begin
  Result := TTesteConfigModuRetagFin.Create;
end;

function ModuRetagFinPagamentoFormaCreate
  : ITesteConfigModuRetagFinPagamentoForma;
begin
  Result := TTesteConfigModuRetagFinPagamentoForma.Create;
end;
