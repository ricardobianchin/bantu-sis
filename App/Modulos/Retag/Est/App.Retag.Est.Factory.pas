...
function RetagVendaDBICreate(pDBConnection: IDBConnection; pAppObj: IAppObj;
  pRetagVendaEnt: IRetagVendaEnt; pUsuarioId: TId): IEntDBI;
...
function RetagVendaItemCreate( //
  ...
  pId: TId; pDescrRed, pFabrNome, pUnidSigla: string; pEstMovQtd: Currency; //
...
function RetagSaldoDBICreate(pDBConnection: IDBConnection;
  pRetagSaldoEnt: IRetagSaldoEnt): IEntDBI;

function EntEdCastToRetagSaldoEnt(pEntEd: IEntEd): IRetagSaldoEnt;

function RetagSaldoDataSetFormCreatorCreate(pFormClassNamesSL: TStringList;
  pUsuarioLog: IUsuario; pDBMS: IDBMS; pOutput: IOutput;
  pProcessLog: IProcessLog; pOutputNotify: IOutput; pEntEd: IEntEd;
  pEntDBI: IEntDBI; pAppObj: IAppObj): IFormCreator;

function RetagSaldoFormCreatorCreate(pFormClassNamesSL: TStringList;
  pUsuarioLog: IUsuario; pDBMS: IDBMS; pOutput: IOutput;
  pProcessLog: IProcessLog; pOutputNotify: IOutput; pAppObj: IAppObj;
  pDBConnection: IDBConnection): IFormCreator;
...
{$ENDREGION}
{$REGION 'uses est saldo'}
    , App.Retag.Est.Saldo.Ent_u //
{$ENDREGION}
...
function RetagSaldoEntCreate( //
  ...
  : IRetagSaldoEnt;
begin
  Result := TRetagSaldoEnt.Create(pLojaId, pProdFabrEnt, pProdTipoEnt,
    pProdUnidEnt, pProdBarrasList, pProdBalancaEnt, pState, pId, pDescr,
    pDescrRed);
end;
...
function RetagSaldoDBICreate(pDBConnection: IDBConnection;
  pRetagSaldoEnt: IRetagSaldoEnt): IEntDBI;
begin
  Result := TRetagSaldoDBI.Create(pDBConnection, pRetagSaldoEnt);
end;

function EntEdCastToRetagSaldoEnt(pEntEd: IEntEd): IRetagSaldoEnt;
begin
  Result := TRetagSaldoEnt(pEntEd);
end;
...
begin
  ...
  oRetagSaldoDBI := RetagEstProdDBICreate(pDBConnection, oRetagSaldoEnt);
...
function RetagVendaDBICreate(pDBConnection: IDBConnection; pAppObj: IAppObj;
  pRetagVendaEnt: IRetagVendaEnt; pUsuarioId: TId): IEntDBI;
begin
  Result := TRetagVendaDBI.Create(pDBConnection, pAppObj, pRetagVendaEnt,
    pUsuarioId);
end;
